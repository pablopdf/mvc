<section class="full-box nav-lateral">
			...
			<div class="full-box nav-lateral-content">
				<figure class="full-box nav-lateral-avatar">
					...
					<img src="<?php echo SERVERURL;?>vistas/assets/avatar/navajas.jpg" class="img-fluid" alt="Avatar">
					<figcaption class="roboto-medium text-center">
						Portman <br><small class="roboto-condensed-light">Fashion Hair Dresser</small>
					</figcaption>
				</figure>
